...
("if (m > 20) add('sync', (m - 20) / se, '🤝', 'Mains décalées — écoute-les ensemble', 'bad', 'Mains décalées');",
 "if (m > 20) add('sync', (m - 20) / se, '🤝', 'Hands out of sync — listen to them together', 'bad', 'Hands out of sync');"),
